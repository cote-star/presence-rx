...
| [../docs/FUTURE_DIRECTIONS.md](../docs/FUTURE_DIRECTIONS.md) | Channel-activation roadmap. Concept-only. Sources the static `/future-directions` page in the Lovable webapp. No real benchmark data, no source names. |
